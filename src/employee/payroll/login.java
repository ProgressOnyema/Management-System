...
PreparedStatement pst = null;
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel2);
        jLabel2.setBounds(50, 190, 70, 14);

        jLabel3.setForeground(new java.awt.Color(255, 255, 255));
        jLabel3.setText("Password:");
        jPanel1.add(jLabel3);
        jLabel3.setBounds(50, 230, 70, 14);
        ...
        txt_username.setBounds(150, 180, 120, 30);
        jPanel1.add(txt_password);
        txt_password.setBounds(150, 220, 120, 30);

        txt_combo.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Admin", "Sales" }));
        jPanel1.add(txt_combo);
        txt_combo.setBounds(150, 260, 120, 20);
        ...
        jButton1.setBounds(190, 290, 80, 23);
        ...
        try {
            ...
            if(access == "Admin") {
                ...
                if(count == 1) {
                    ...
                    String reg = "insert into Audit (emp_id, date, status) values ('"+idValue+"', '"+timeValue+" / "+dateValue+"', 'Logged In')";
